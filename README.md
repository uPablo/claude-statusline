<p align="center">
  <img src="banner.jpg" alt="claude-statusline" width="100%">
</p>

# claude-statusline

[![CI](https://github.com/uPablo/claude-statusline/actions/workflows/ci.yml/badge.svg)](https://github.com/uPablo/claude-statusline/actions/workflows/ci.yml)
...
```
claude-statusline:main ✓ ↑1 (uPablo/claude-statusline) · ⬢ 20.19.0  🐘 8.4.5 · +1.2k/-340
